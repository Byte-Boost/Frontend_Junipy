export enum allergiesEnum {
    ...
    foodAllergies = "auth.register.fields.anamnese.fields.allergies.choices.foodAllergies",
    medicalAllergies = "auth.register.fields.anamnese.fields.allergies.choices.medicalAllergies",
}